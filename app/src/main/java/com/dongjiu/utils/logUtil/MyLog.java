package com.dongjiu.utils.logUtil;
 ...
 */
public class MyLog {
	private static Boolean MYLOG_SWITCH = false; // 日志文件总开关           此处false  不再记录日志
	private static Boolean MYLOG_WRITE_TO_FILE = false;// 日志写入文件开关   此处false  不再记录日志 写成文件的形式
