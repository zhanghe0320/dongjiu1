 ...
 */
public class CaptureFragment2 extends Fragment implements OnCaptureCallback {
    ...
    public static CaptureFragment2 newInstance() {

        Bundle args = new Bundle();

        CaptureFragment2 fragment = new CaptureFragment2();
