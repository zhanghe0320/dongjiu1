package com.dongjiu.utils.zxing;
...
public final class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        frameRatio = array.getFloat(R.styleable.ViewfinderView_frameRatio,0.5f);
        array.recycle();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int topOffset = (screenHeight/2 - frameHeight) / 2 + getPaddingTop() - getPaddingBottom();
        frame = new Rect(leftOffset, topOffset, leftOffset + frameWidth, topOffset + frameHeight);
        //frame = new Rect(20, 20, 20 +frameWidth, 20 +frameHeight);
    }
